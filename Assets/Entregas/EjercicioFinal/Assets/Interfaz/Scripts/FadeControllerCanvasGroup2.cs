...
public class FadeControllerCanvasGroup2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        controller2 = objetoDirector2.GetComponent<DirectorController>();
    ...
    public void FadeBlackThenBack()
    {
        ...
        objetoDirector2.gameObject.SetActive(false);
    }
